            ...
            <asp:Repeater ID="rptItemListView" runat="server"
                ...
                <FooterTemplate>
                    <div class="panel-footer">
                        <asp:LinkButton ID="lnkAll" runat="server" CssClass="btn btn-primary link-all" ResourceKey="AllItems.Text" Visible="True" Enabled="True" />
                        <div class="btn-group pull-right">
                            <asp:LinkButton ID="lnkPrev" runat="server" CssClass="btn btn-primary link-prev" ResourceKey="PrevItem.Text" Visible="True" Enabled="True" OnClick="lnkPrev_Click" />
                            <asp:LinkButton ID="lnkNext" runat="server" CssClass="btn btn-primary link-next" ResourceKey="NextItem.Text" Visible="True" Enabled="True" OnClick="lnkNext_Click" />
                        </div>
                    </div>
                </FooterTemplate>
            </asp:Repeater>
            ...
            <asp:Repeater ID="rptItemAccordionView" runat="server"
                ...
                <FooterTemplate>
                    <div class="panel-footer">
                        ...
                        <div class="btn-group pull-right">
                            <asp:LinkButton ID="lnkPrev" runat="server" CssClass="btn btn-primary link-prev" Visible="false" ResourceKey="PrevItem.Text" CommandName="Previous" OnClick="lnkPrev_Click" />
                            <asp:LinkButton ID="lnkNext" runat="server" CssClass="btn btn-primary link-next" Visible="false" ResourceKey="NextItem.Text" CommandName="Next" OnClick="lnkNext_Click" />
                        </div>
                    </div>
                </FooterTemplate>
            </asp:Repeater>
