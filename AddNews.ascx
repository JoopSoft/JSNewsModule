...
<div class="dnnForm dnnEditBasicSettings add-news" id="dnnEditBasicSettings">
    ...
    <fieldset>
        ...
        <div class="dnnFormItem">
            ...
            <asp:FileUpload ID="btnImgSelect" runat="server" CssClass="btn btn-primary" />
            <asp:LinkButton ID="btnImgUpload" runat="server" ResourceKey="btnUpload.Text" CssClass="dnnSecondaryAction" OnClick="btnImgUpload_Click" />
        </div>
...
<%--<dnn:DnnJsInclude ID="DnnJsInclude1" runat="server" FilePath="/DesktopModules/JSNewsModule/Js/main.js" />--%>
